...
export const Pre = forwardRef<HTMLPreElement, HTMLAttributes<HTMLPreElement>>(
  ({ className, ...props }, ref) => {
    return (
      <pre
        ref={ref}
        className={cn("p-4 focus-visible:outline-none !bg-grey-900", className)}
        {...props}
      >
        {props.children}
      </pre>
  ...
  (
    ...
    return (
      <figure
        ...
        {...props}
        className={cn(
          "not-prose group fd-codeblock relative overflow-hidden rounded-lg border border-border/10 text-sm !bg-grey-900",
          keepBackground &&
